...
/**
 * A Substitution is basically a map of Entry object (first, second)
 * If it is applied to something like a Signature, presumably all variables of name first are replaced by name second
 */
class Substitution {
