...
struct USignature {
    ...
    USignature substitute(const Substitution& s) const; // Create a copy of the USignature and perform the substitution on it
    void apply(const Substitution& s); // perform the substitution on this USignature itself in-place
...
struct Signature {
    ...
    Signature substitute(const Substitution& s) const; // Create a copy of the USignature and perform the substitution on it
    void apply(const Substitution& s); // perform the substitution on this USignature itself in-place
